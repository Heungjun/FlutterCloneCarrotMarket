      ...
      itemBuilder: (context, index) {
        return Row(
          children: [
            ...
            Column(
              children: [
                Text(data['ara'][index]['title']),
                Text(data['ara'][index]['location']),
                Text(data['ara'][index]['price']),
                Row(
                  children: [
                    SvgPicture.asset(
